...
Main.__name__ = true;
Main.main = function() {
	kha_System.init({ title : "Game", width : 1024, height : 768},function() {
		new Game();
	});
};
Math.__name__ = true;
...
MenuState.prototype = $extend(State.prototype,{
	...
	,render: function(framebuffer) {
		State.prototype.render.call(this,framebuffer);
...
PlayState.__super__ = State;
PlayState.prototype = $extend(State.prototype,{
	create: function() {
		State.prototype.create.call(this);
		haxe_Log.trace("Creating Play State",{ fileName : "PlayState.hx", lineNumber : 17, className : "PlayState", methodName : "create"});
	}
	,destroy: function() {
		State.prototype.destroy.call(this);
	}
	...
	,render: function(framebuffer) {
		State.prototype.render.call(this,framebuffer);
		haxe_Log.trace("Rendering Play State",{ fileName : "PlayState.hx", lineNumber : 33, className : "PlayState", methodName : "render"});
		var g = framebuffer.get_g2();
		g.begin();
		g.set_color(kha__$Color_Color_$Impl_$.Orange);
